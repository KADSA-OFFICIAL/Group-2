...
게임의 기본 재화 시스템입니다. 플레이어는 여러 종류의 재화(돌, 주석, 구리, 철광석, 석탄, 골드, 신앙석)를 획득하고 소비할 수 있으며, 게임 종료 시에도 데이터가 저장됩니다.

## 주요 기능

- **다중 재화 타입 지원**: 7가지 재화 타입 (돌, 주석, 구리, 철광석, 석탄, 골드, 신앙석)
...
| 영문명 | 한국명 | 설명 |
|--------|---------|------|
| stone | 돌 | 건설 및 제작 기본 재료 |
| tin | 주석 | 청동 제작에 필요 |
| copper | 구리 | 청동 제작에 필요 |
| iron_ore | 철광석 | 철기 제작에 필요 |
| coal | 석탄 | 연료 및 제작 재료 |
| gold | 골드 | 귀중한 통화 |
